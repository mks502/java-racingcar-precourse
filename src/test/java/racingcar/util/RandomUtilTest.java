...
import static racingcar.constant.MoveConditionRule.MAX_NUM;
import static racingcar.constant.MoveConditionRule.MIN_NUM;
...
class RandomUtilTest {
    ...
    void 랜덤값_생성_확인() {
        for(int i = 0; i< ENOUGH_TEST_COUNT; i++){
            ...
            assertThat(randomNumber).isBetween(MIN_NUM,MAX_NUM);
        }
    }
}
